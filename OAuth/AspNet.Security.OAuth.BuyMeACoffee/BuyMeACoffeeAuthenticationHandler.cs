...
{
    public class BuyMeACoffeeAuthenticationHandler : OAuthHandler<BuyMeACoffeeAuthenticationOptions>
    {
        public BuyMeACoffeeAuthenticationHandler(
            [NotNull] IOptionsMonitor<BuyMeACoffeeAuthenticationOptions> options,
