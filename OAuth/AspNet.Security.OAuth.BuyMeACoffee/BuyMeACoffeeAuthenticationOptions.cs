...
{
    /// <summary>
    /// Defines a set of options used by <see cref="BuyMeACoffeeAuthenticationHandler"/>.
    /// </summary>
    public class BuyMeACoffeeAuthenticationOptions : OAuthOptions
    {
        public BuyMeACoffeeAuthenticationOptions()
        {
            ClaimsIssuer = BuyMeACoffeeAuthenticationDefaults.Issuer;
            CallbackPath = BuyMeACoffeeAuthenticationDefaults.CallbackPath;

            AuthorizationEndpoint = BuyMeACoffeeAuthenticationDefaults.AuthorizationEndpoint;
            TokenEndpoint = BuyMeACoffeeAuthenticationDefaults.TokenEndpoint;
            UserInformationEndpoint = BuyMeACoffeeAuthenticationDefaults.UserInformationEndpoint;
